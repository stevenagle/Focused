...
START TRANSACTION;
USE `focuseddb`;
INSERT INTO `focuseddb`.`company` (`id`, `name`, `username`, `password`, `description`) VALUES (1, 'CSS Hub', 'csshub', 'csshub', 'front end devs');
INSERT INTO `focuseddb`.`company` (`id`, `name`, `username`, `password`, `description`) VALUES (2, 'Acme', 'acme', 'acme', 'makes stuff');
...
START TRANSACTION;
USE `focuseddb`;
INSERT INTO `focuseddb`.`reviewer` (`id`, `username`, `password`, `age`, `gender`) VALUES (1, 'user1', 'user1', 24, 'M');
INSERT INTO `focuseddb`.`reviewer` (`id`, `username`, `password`, `age`, `gender`) VALUES (2, 'user2', 'user2', 30, 'M');
INSERT INTO `focuseddb`.`reviewer` (`id`, `username`, `password`, `age`, `gender`) VALUES (3, 'user3', 'user3', 21, 'F');
