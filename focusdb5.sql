...
START TRANSACTION;
USE `focuseddb`;
INSERT INTO `focuseddb`.`reviewer` (`id`, `username`, `password`, `age`, `gender`, `photo_url`, `points`) VALUES (1, 'user1', 'user1', 51, 'M', 'http://www.thewrap.com/wp-content/uploads/2013/10/Walter-White-funeral.jpg', 0);
INSERT INTO `focuseddb`.`reviewer` (`id`, `username`, `password`, `age`, `gender`, `photo_url`, `points`) VALUES (2, 'user2', 'user2', 30, 'M', 'http://skilldistillery.com/wp-content/uploads/2016/01/IMG_4471-500x310.jpg', 0);
INSERT INTO `focuseddb`.`reviewer` (`id`, `username`, `password`, `age`, `gender`, `photo_url`, `points`) VALUES (3, 'user3', 'user3', 21, 'F', 'http://www.billboard.com/files/styles/article_main_image/public/media/lady-gaga-golden-globes-bw-2016-billboard-650.jpg', 100);
...
INSERT INTO `focuseddb`.`reviewer` (`id`, `username`, `password`, `age`, `gender`, `photo_url`, `points`) VALUES (5, 'user5', 'user5', 30, 'F', 'http://img.wennermedia.com/article-leads-vertical-300/1251312975_kim_kardashian_290x402.jpg', 500);
